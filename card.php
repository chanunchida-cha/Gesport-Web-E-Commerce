...
if(!empty($_SESSION['cart']))
{
	...
	foreach($_SESSION['cart'] as $p_id=>$qty)
	{
		...
		//remove product
		echo "<td width='46' align='center'><a href='card.php?p_id=$p_id&act=remove'>ลบ</a></td>";
		echo "</tr>";
	}
	echo "<tr>";
...
<td colspan="4" align="right">
    ...
    <input type="button" name="Submit2" value="สั่งซื้อ" onclick="window.location='./comfirm.php';" />
    <input type="button" name="btn-cancel" value="ยกเลิกสั่งซื้อ" onclick="window.location='card.php?act=cancel';" />
</td>
</tr>
</table>
</form>

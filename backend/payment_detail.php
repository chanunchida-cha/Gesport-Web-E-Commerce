...
<body style="font-family: 'Kanit', sans-serif;">
    <h5>รายละเอียดการแจ้งชำระเงิน</h5>
    <table class="table table-bordered">
        ...
        echo "<td align='right' bgcolor='#fff'>" . "<b>"."<font color='black'>" . number_format($total, 2)."</font>" . "</b>" . "</td>";
    ...
    <div class="col-sm-6">
        <h6>แจ้งเลขEMS</h6>
        <form action="../backend/ems_db.php" method="post" class="form-horizontal">
            <div class="from-group">
                <div class="col-sm-2 control-label">EMS</div>
                <div class="col-sm-4">
                    <input type="text" name="o_ems" class="form-control" required minlength="13" placeholder="เลขems">
                </div>
                <br>
                <div class="col-sm-2">

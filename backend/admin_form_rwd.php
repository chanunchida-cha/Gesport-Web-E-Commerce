...
<form action="../backend/admin_form_rwd_db.php" method="post" class="form-horizontal">
  <div class="contain-member-rwd">
    ...
    <div class="form-group">
      ...
      <div>
        <input type="text" name="a_user" required class="form" autocomplete="off" value="<?php echo $row['a_user']; ?>" disabled>
      </div>
    </div>
    <div class="form-group">
      <div class="col-topic">
      ...
      <div>
        <input type="password" name="a_pass1" required class="form">
      </div>
    </div>
    <div class="form-group">
      <div class="col-topic">
      ...
      <div>
        <input type="password" name="a_pass2" required class="form">
      </div>
    </div>
    <div class="form-group">
      <div class="col-sm-3">
